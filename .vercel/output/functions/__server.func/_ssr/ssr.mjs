...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C4SlOHq5.mjs");
...
var manifest = {
	"023358a8fa0547c50d1b7af320e16931f01bac731485f596a912443526d5773b": {
		functionName: "deleteReagent_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"41f6014d6fc8e2f1a95e5dda810946149b2b3b2591ac051f0d10c737107a7fe7": {
		functionName: "createRestockOrder_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"a29f4f762435b1ada22aede26a09782cdb3fa981b5204b0812182f1d842bc7f2": {
		functionName: "receiveOrder_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"c43bab918abed429bb65984405d1d993a78388340554c9c68f68bf362611f3d7": {
		functionName: "listReagents_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"d3f40c05a48560310858d107e6fee9c3929f145199f9d002883522c4d950f62b": {
		functionName: "listStockRecords_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"f0381a8579af96b684ecf8a33582e86ec4861dd734b19b6a2108d26b38e5ea5e": {
		functionName: "saveReagent_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"f207e7ae9b22927fa79a50a8e0a9b14e9da3d264aaf1fffdfa2a475992f9215b": {
		functionName: "listOrders_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	},
	"f94c1289840551a23f35e137450d6da18ea52fb2ef2befcd5430da991068ef09": {
		functionName: "submitStockBatch_createServerFn_handler",
		importer: () => import("./reagents-DbQZQAej.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CelxkpCO.mjs").then((n) => n.t),
