...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CelxkpCO.js
...
var styles_default = "/assets/styles-BXIx0VV7.css";
var APP_NAME = "权盾智检";
...
var listReagents = createServerFn({ method: "GET" }).handler(createSsrRpc("c43bab918abed429bb65984405d1d993a78388340554c9c68f68bf362611f3d7"));
var saveReagent = createServerFn({ method: "POST" }).validator(reagentInput).handler(createSsrRpc("f0381a8579af96b684ecf8a33582e86ec4861dd734b19b6a2108d26b38e5ea5e"));
createServerFn({ method: "POST" }).validator(object({ id: number() })).handler(createSsrRpc("023358a8fa0547c50d1b7af320e16931f01bac731485f596a912443526d5773b"));
...
})).handler(createSsrRpc("f94c1289840551a23f35e137450d6da18ea52fb2ef2befcd5430da991068ef09"));
var listStockRecords = createServerFn({ method: "GET" }).handler(createSsrRpc("d3f40c05a48560310858d107e6fee9c3929f145199f9d002883522c4d950f62b"));
var createRestockOrder = createServerFn({ method: "POST" }).validator(object({ note: string().optional().default("") }).optional()).handler(createSsrRpc("41f6014d6fc8e2f1a95e5dda810946149b2b3b2591ac051f0d10c737107a7fe7"));
var listOrders = createServerFn({ method: "GET" }).handler(createSsrRpc("f207e7ae9b22927fa79a50a8e0a9b14e9da3d264aaf1fffdfa2a475992f9215b"));
var receiveOrder = createServerFn({ method: "POST" }).validator(object({
	id: number(),
	operator: string().optional().default("检验员")
})).handler(createSsrRpc("a29f4f762435b1ada22aede26a09782cdb3fa981b5204b0812182f1d842bc7f2"));
var $$splitComponentImporter = () => import("./routes-eYbWKnQq.mjs");
var Route = createFileRoute("/")({
	loader: async () => {
		const [reagents, records, orders] = await Promise.all([
			listReagents(),
			listStockRecords(),
			listOrders()
		]);
...
//#endregion
export { listReagents as a, saveReagent as c, listOrders as i, submitStockBatch as l, Route as n, listStockRecords as o, createRestockOrder as r, receiveOrder as s, router_exports as t };
